...
Point(19) = {0.2, 0.4, 0, _cl_finer};
Point(20) = {0, 0.4, 0, _cl_finer};
Point(21) = {0.2, 0, 0, _cl_finer};

Point(22) = {0.15, 0.35, 0, _cl_finer};
Point(23) = {0.0, 0.35, 0, _cl_finer};
Point(24) = {0.15, 0.0, 0, _cl_finer};
...
Point(44) = { cl_fine, 0.6 , 0, _cl_finer*2};
Point(45) =  { 0, 0.6 , 0, _cl_finer*2};
Point(46) = {cl_fine, 0.6 - cl_fine, 0, _cl_finer*2};
Point(47) = {0, 0.6 - cl_fine, 0, _cl_finer*2};

Point(52) = {0.4 + cl_fine,  cl_fine, 0, _cl_finer*2};
Point(53) = {0.4 - cl_fine,  cl_fine, 0, _cl_finer*2};
Point(54) = {0.4 + cl_fine,  0, 0, _cl_finer*2};
Point(55) = {0.4 - cl_fine,  0, 0, _cl_finer*2};
