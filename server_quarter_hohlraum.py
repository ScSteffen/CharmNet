...
from src.config_utils import generate_log_filename, read_config_file, update_parameter, write_config_file, remove_files, update_quarter_hohlraum_mesh_file
...
class KiTRTModelQuarterHohlraum(umbridge.Model):
    ...
    def __call__(self, parameters, config):
        ...
        lattice_file_new = update_quarter_hohlraum_mesh_file(n_cells, subfolder + 'mesh/')
        ...
        log_file_cur = f'quad_hohlraum_p{n_cells}_q{quad_order}'
        ...
        generated_cfg_file = subfolder + f'quad_hohlraum_p{n_cells}_q{quad_order}.cfg'
...
kitrtmodel = KiTRTModelQuarterHohlraum()
